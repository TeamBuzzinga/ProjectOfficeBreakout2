...
public class ChangPlayerController : MonoBehaviour
{
	...
	public float animSpeed = 2.0f;				// a public setting for overall animator animation speed
...
//		float vol = Random.Range (volLowRange, volHighRange);
		...
		if (currentBaseState.nameHash == locoState) {
			...
			if(Input.GetKey(KeyCode.LeftShift) && !isIce)
			{
				if(!audioSource.isPlaying){
